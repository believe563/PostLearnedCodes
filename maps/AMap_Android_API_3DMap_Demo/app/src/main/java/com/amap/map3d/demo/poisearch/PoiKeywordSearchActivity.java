...
public class PoiKeywordSearchActivity extends FragmentActivity implements
	...
	private void setUpMap() {
		Button searButton = (Button) findViewById(R.id.searchButton);//开始搜索按钮
		searButton.setOnClickListener(this);
		Button nextButton = (Button) findViewById(R.id.nextButton);//下一页按钮
		nextButton.setOnClickListener(this);
		searchText = (AutoCompleteTextView) findViewById(R.id.keyWord);//关键字
		searchText.addTextChangedListener(this);// 添加文本输入框监听事件
		editCity = (EditText) findViewById(R.id.city);//城市
