...
//	@SuppressWarnings("deprecation")//deprecation 贬低 反对
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCircleCanvas.setPadding(600, 20, 20,20);
		//将circleCanvas对象添加到当前界面的视图中（两个按钮的下方）
		viewGroup.addView(mCircleCanvas,new LayoutParams(LinearLayout.LayoutParams.FILL_PARENT,LinearLayout.LayoutParams.FILL_PARENT));
