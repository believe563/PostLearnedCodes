package com.fengjianghui.personal.gaodeditudemo.util;
...
import com.fengjianghui.personal.gaodeditudemo.R;
...
public class TTSController implements SynthesizerListener, AMapNaviListener {
    ...
    // 合成对象.
    private SpeechSynthesizer mSpeechSynthesizer = SpeechSynthesizer.createSynthesizer(mContext);
    /**
     * 用户登录回调监听器.
     */
    ...
    public void init() {
        SpeechUser.getUser().login(mContext, null, null,
                "appid=" + mContext.getString(R.string.app_name), listener);
        // 初始化合成对象.
