...
public class SQLiteReadHelper01 {
	...
	public SQLiteReadHelper01(Context context,String databaseName,int ResId) {
	...
	public Object getDatabaseData(){
		...
		Cursor cursor = db.query("qiuShiBaiKe", null, null, null, null, null, null);
		List<QiuShiBaiKe> dataList = new ArrayList<QiuShiBaiKe> ();
		if (cursor.moveToFirst()) {
			do {
				QiuShiBaiKe data = new QiuShiBaiKe();
